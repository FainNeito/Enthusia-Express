...
- [x] **INFRA-011** — Verify the Java 25 Paper APIs and retain the baseline distribution.
  ...
  Evidence: Paper official Maven metadata publishes 26.2.build.123-stable and 26.3-pre-2.build.0-alpha (https://repo.papermc.io/repository/maven-public/io/papermc/paper/paper-api/maven-metadata.xml), verified 2026-09-13. Paper project setup documents the new coordinate format and Java 25 requirement (https://docs.papermc.io/paper/dev/project-setup/). Gradle's compatibility matrix requires 9.1.0 for Java 25 (https://docs.gradle.org/current/userguide/compatibility.html). Kotlin 2.3.21 supports Gradle 9.1 (https://kotlinlang.org/docs/gradle-configure-project.html); Shadow 9.2.2 supports Gradle 9 (https://gradleup.com/shadow/). Mockito 5.20.0 uses Byte Buddy 1.17.7 for Java 25 (https://github.com/mockito/mockito/releases/tag/v5.20.0). All four pinned artifact POMs and the Gradle SHA256 were fetched from their official repositories. Existing org.jetbrains.kotlin.gradle.dsl.JvmTarget and Gradle toolchain DSL support per-target compilation. ASM 9.8 adds Java 25 bytecode inspection (https://asm.ow2.io/versions.html). No production API or layer change is planned; the bundled Kotlin standard library follows the compiler upgrade. Prerelease API verification does not establish final 26.3 or live integration support.
